...
![calculator](https://source.unsplash.com/h63fLedowK8)
...
6. Gotchas: watch out for and fix these bugs if they show up in your code:
    ...
    - Display a snarky error message if the user tries to divide by 0… don’t let it crash your calculator[^1]!
...
---
This ReadMe.MD was styled using [GitHub](https://docs.github.com/en/get-started/writing-on-github/getting-started-with-writing-and-formatting-on-github/basic-writing-and-formatting-syntax).


[^1]: [Snarky Message Examples](https://parade.com/1079501/stephanieosmanski/sarcastic-quotes/)
